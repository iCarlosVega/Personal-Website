            ...
            <div className="about-me-container">
                ...
                <div className="about-me-facts-section">
                    ...
                    <ul className="about-me-facts-list">
                        ...
                        <li>I started taking squash and tennis a little more seriously, you need to touch grass some times.</li>
                        <li>Can be a degen gamer from time to time, peaked in rivals Celestial 3 (check my <a href="https://tracker.gg/marvel-rivals/profile/ign/LookinFoSWEjob/overview?season=6&mode=competitive" target="_blank" rel="noopener noreferrer">tracker.gg</a>) lmao, but recently started playing runescape.</li>
                    </ul>
                </div>
            </div>
        </div>
